<?php
  ...
  /***
   * @file
   * Provide site administrators with a list of all the RSVP List signups so
   * they know who is attending their events
   */
   ...
   class ReportController extends ControllerBase {
     ...
     * These are returned as an associative array, with reach row
    ...
    protected function load() {
      try {
        // https://www.drupal.org/docs/8/qpi/database-api/dynamic-queriess/introduction-to-dynamic-queries
         ...
         * For fetchAll(), it is the first paramenter.
    ...
    public function report() {
      ...
      $content['message'] = [
        '#markup' => t('Below is a list of all Event RSVPs including username, email address and thename of the event they will be attending.'),
      ];
       ...
       * as its own array, we can simply define the HTML table row like this:
       */
