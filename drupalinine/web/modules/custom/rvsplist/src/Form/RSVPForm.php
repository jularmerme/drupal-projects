      ...
      */
      public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['email'] = [
          ...
          '#size'             => 25,
          '#description'   => t("We will send updates to the emails address you provide."),
          '#required'       => TRUE,
        ];
        $form['submit'] = [
          '#type' => 'submit',
      ...
      public function validateForm(array &$form, FormStateInteface $form_state) {
        ...
        if(!(\Drupal::service('email.validator')->isValid($value))) {
          $form_state->setErrorByName('email', $this->t('It appears the email is not a valid %mail. Please try again', ['%mail' => $value]));
        }
      }
      ...
      public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        try {
          ...
          \Drupal::messenger()->addMessage()->addError(
